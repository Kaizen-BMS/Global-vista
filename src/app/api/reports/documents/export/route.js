...
const COLUMNS = [
  ...
  ["related_number", "Reference"], ["uploaded_by_name", "Uploaded By"], ["file_size", "Size (bytes)"], ["created_at", "Uploaded At"],
];
...
export const GET = withErrorHandling(async (request) => {
  ...
  return buildExportResponse(docs, COLUMNS, { format, filenameBase: "documents-export", sheetName: "Documents" });
});
