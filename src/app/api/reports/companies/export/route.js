...
const COLUMNS = [
  ...
  ["user_count", "Users"], ["enabled_module_count", "Enabled Modules"], ["created_at", "Created At"],
];
...
export const GET = withErrorHandling(async (request) => {
  ...
  return buildExportResponse(companies, COLUMNS, { format, filenameBase: "companies-export", sheetName: "Companies" });
});
