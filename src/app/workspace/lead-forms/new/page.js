...
export default async function NewLeadFormPage() {
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold text-white mb-1">Create Lead Form</h1>
      <p className="text-neutral-500 text-sm mb-6">Build a public form — anyone with the link or QR code can submit it, no login required.</p>
