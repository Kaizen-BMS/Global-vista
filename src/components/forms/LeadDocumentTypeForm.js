...
export default function LeadDocumentTypeForm({ initial, onClose, onSaved }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <ModalFocusTrap>
      <form onSubmit={handleSubmit} role="dialog" aria-modal="true" aria-label={isEdit ? "Edit Document Type" : "New Document Type"} className="relative w-full max-w-md max-h-[88vh] overflow-y-auto bg-card border border-border rounded-2xl shadow-2xl">
