...
export function fail(message = "Something went wrong.", status = 500, extra = {}) {
...
export function badRequest(message = "Invalid request.", extra = {}) {
  return fail(message, 400, extra);
}

/** Wraps a route handler, converting thrown errors (incl. assertPermission) into responses. */
